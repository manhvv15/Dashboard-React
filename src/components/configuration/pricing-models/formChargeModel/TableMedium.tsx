...
import ListPriceMarketTier from './ListPriceMarketTier';
...
export default function TableMedium({ stt }: Props) {
  const {
    control,
    setValue,
    watch,
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-center">
                      <span className="ml-2">{common('flatFee')}</span>
                    </div>
                  </th>
                );
              })}
            ...
            {fields.map((field, index) => {
              ...
              return (
                <tr className="p-2 border-x border-ic-ink-2s" key={field.id}>
                  <ListPriceMarketTier fields={fields} packageIndex={stt} column={index} />
