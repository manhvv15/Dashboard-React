...
import { getBidItemLink } from '@/utils/bid';
...
export const LoseBidManageGrid = ({ dataSource, previousTotal }: Props) => {
  ...
  return <DataGrid rowData={dataSource} columnDefs={columns} rowKey={'id'} rowHeight={60} />;
};
